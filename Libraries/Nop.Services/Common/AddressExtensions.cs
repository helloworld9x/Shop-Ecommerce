    ...
    public static class AddressExtensions
    {
            ...
            string zipPostalCode, int? countryId)
        {
            return
                source.Find(
                    a =>
                        ((String.IsNullOrEmpty(a.FirstName) && String.IsNullOrEmpty(firstName)) ||
                        ...
                        ((String.IsNullOrEmpty(a.FaxNumber) && String.IsNullOrEmpty(faxNumber)) ||
                        ...
                        ((a.StateProvinceId.IsNullOrDefault() && stateProvinceId.IsNullOrDefault()) ||
