...
var Console, ConsoleQueue, MessageLevel, MessageSource, MessageType, OriginalConsole, RemoteConsole, Timeline, UsingRemote, Weinre;
...
args = [].slice.call(arguments);
if (UsingRemote) {
this._generic(MessageLevel.Log, args);
} else {
ConsoleQueue.push(function() {
return RemoteConsole._generic(MessageLevel.Log, args);
});
}
...
args = [].slice.call(arguments);
if (UsingRemote) {
this._generic(MessageLevel.Debug, args);
} else {
ConsoleQueue.push(function() {
return RemoteConsole._generic(MessageLevel.Debug, args);
});
}
...
args = [].slice.call(arguments);
if (UsingRemote) {
this._generic(MessageLevel.Error, args);
} else {
ConsoleQueue.push(function() {
return RemoteConsole._generic(MessageLevel.Error, args);
});
}
...
args = [].slice.call(arguments);
if (UsingRemote) {
this._generic(MessageLevel.Warning, args);
} else {
ConsoleQueue.push(function() {
return RemoteConsole._generic(MessageLevel.Warning, args);
});
}
return OriginalConsole.warn([].slice.call(arguments));
};
